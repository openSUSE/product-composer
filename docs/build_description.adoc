...
are sha256 and sha512. sha512 is the default. List both
in case bother are wanted.
...
Filter updateinfo data and the corresponding rpm files when the issue date is
