...
aka installer images. But it can used for example iso images
with the agama-installer and copies it's build result.

Define an image prefix via base which needs to be available in
/usr/libexec/base-isos directory.
